...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picPokedex 
      ...
      Begin VB.PictureBox picFD 
         ...
         Width           =   1410
      End
      Begin Project1.PictureG picFaces 
         Height          =   1215
         Left            =   2640
         Top             =   600
         Width           =   2775
   ...
   Begin VB.PictureBox PicBatalha 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmMain.frx":B804E9
         Left            =   840
         List            =   "frmMain.frx":B804F0
         TabIndex        =   224
         Text            =   "Combo2"
         Top             =   6360
         Width           =   1215
...
If GetPlayerTeleport(MyIndex, lstTeleport.ListIndex + 1) > 0 Then
    Select Case lstTeleport.ListIndex
        Case 0: WarpPlayer 1, 12, 10
        Case 1: WarpPlayer 2, 12, 10
        Case 2: WarpPlayer 3, 12, 10
        Case 3: WarpPlayer 4, 12, 10
        Case 4: WarpPlayer 5, 12, 10
        Case 5: WarpPlayer 6, 12, 10
        Case Else
            AddText "bug", White
    End Select
End If
...
Private Sub picTele_Click()
    ...
    frmMain.picTeleport.top = (frmMain.ScaleHeight / 2) - (frmMain.picTeleport.Height / 2)
    frmMain.picTeleport.Left = (frmMain.ScaleWidth / 2) - (frmMain.picTeleport.Width / 2)
...
' If debug mode, handle error then exit out
    ...
    Exit Sub
errorhandler:
    HandleError "picTeleport_MouseMove", "frmMain", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
