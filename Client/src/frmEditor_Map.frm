...
Begin VB.Form frmEditor_Map 
   ...
   Begin VB.Frame fraAttribs 
      ...
      Begin VB.OptionButton optScript 
         ...
         Width           =   1215
      End
      Begin VB.OptionButton OptFlyAvoid 
         Caption         =   "Fly Avoid"
         Height          =   270
         Left            =   120
         TabIndex        =   96
      ...
      Begin VB.OptionButton OptWater 
         ...
         Width           =   1215
      End
      Begin VB.OptionButton optGrass 
         Caption         =   "Grass"
         Height          =   270
         Left            =   120
         TabIndex        =   89
...
Private Sub Command1_Click()
    MapEditorScript = scrlScript.value
    picAttributes.Visible = False
...
' If debug mode, handle error then exit out
    ...
    Exit Sub
errorhandler:
    HandleError "OptFishing_Click", "frmEditor_Map", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
...
' If debug mode, handle error then exit out
    ...
    Exit Sub
errorhandler:
    HandleError "OptWater_Click", "frmEditor_Map", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
...
Private Sub scrlScript_Change()
    lblScript.Caption = " 0" & scrlScript.value
    MapEditorScript = scrlScript.value
End Sub
