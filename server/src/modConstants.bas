...
Public Const MAX_INV As Long = 30
...
Public Const MAX_POKE_SPELL As Long = 4
Public Const MAX_ORG_SHOP As Byte = 20
Public Const MAX_BAU As Byte = 15
Public Const MAX_ORGS As Byte = 4
...
Public Const TILE_TYPE_HEAL As Byte = 12 'PokeCentro
...
Public Const START_X As Long = 14
